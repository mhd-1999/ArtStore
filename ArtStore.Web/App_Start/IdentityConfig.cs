...
namespace ArtStore.Web
{
    ...
    public class AccountManager : UserManager<Account>
    {
        ...
        {
            var manager = new AccountManager(new UserStore<Account>(context.Get<ArtStoreContext>()));
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<IdentityRole>(context.Get<ArtStoreContext>()));
        }
    }
